  ...
  const updateLocation = (oldLocation, newLocation) => {
    setLocations(
      locations.map((location) =>
        location === oldLocation ? newLocation : location
      )
    );
  };
    ...
    <Router>
      <div className="app">
        ...
        <Routes>
          ...
          <Route
            path="/recently-added"
            element={<RecentlyAddedItems items={items} />}
          />
          <Route
            path="/add-item"
            element={
          ...
          <Route
            ...
            element={
              <CustomLabelListView
                title="All Custom Labels"
                items={items
                  .filter((i) => i.customLabel)
                  .map((i) => i.customLabel)}
              />
            }
          />
